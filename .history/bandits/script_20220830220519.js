...
const Attack1 = new Player(attack3)
const Attack1 = new Player(attack4)
const Attack1 = new Player(attack5)
const Attack1 = new Player(attack6)
const Attack1 = new Player(attack7)
